...
Ainda não sabe se os hooks rodam nesta máquina? node bin/hm.mjs verificar-hooks
...
não aparecer, é a precedência de workspace sobre usuário — rode: node bin/hm.mjs instalar --workspace <repo>

Próximo passo: node bin/hm.mjs verificar-hooks --limpar   e depois   node bin/hm.mjs instalar`);
    return;
  }
...
AGORA:
  ...
  3. volte aqui e rode:  node bin/hm.mjs verificar-hooks --conferir
